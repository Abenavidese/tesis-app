...
vaca,"Vacas de granja: estas imágenes muestran una variedad de vacas en su hábitat, tanto pastando en campos abiertos como interactuando en grupos. Las fotos capturan diferentes razas y edades, resaltando su vida en el campo y sus distintos comportamientos."
...
leon,"Animales salvajes: aquí se puede ver un león de frente en su hábitat, con algo de vegetación alrededor, porque es un animal salvaje que vive en la naturaleza."
...
tigre,"Animales salvajes: aquí se puede ver un tigre de frente, un felino grande y fuerte, carnívoro, porque es un animal salvaje que vive en la naturaleza."
