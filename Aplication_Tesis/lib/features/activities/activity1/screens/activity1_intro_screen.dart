...
import 'activity1_game_screen.dart';

class Activity1IntroScreen extends StatelessWidget {
  const Activity1IntroScreen({super.key});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          _buildStep('1', '📸', 'Toma una foto'),
                          const SizedBox(height: 8),
                          _buildStep('2', '👀', 'Observa la imagen'),
                          const SizedBox(height: 8),
                          _buildStep('3', '🎤', 'Di lo que ves'),
                          const SizedBox(height: 8),
                  ...
                  child: InkWell(
                    onTap: () {
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const Activity1GameScreen(),
                        ),
                      );
                    },
                    borderRadius: BorderRadius.circular(24),
